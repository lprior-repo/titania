...
proptest! {
    ...
    #[test]
    fn lane_from_str_to_string_round_trip(lane in prop::sample::select(vec![titania_core::Lane::Fmt, titania_core::Lane::Compile, titania_core::Lane::Clippy, titania_core::Lane::AstGrep, titania_core::Lane::Dylint, titania_core::Lane::PanicScan, titania_core::Lane::PolicyScan, titania_core::Lane::Test, titania_core::Lane::Deny, titania_core::Lane::Build])) {
    ...
    #[test]
    fn lane_serde_round_trip_all(lane in prop::sample::select(vec![titania_core::Lane::Fmt, titania_core::Lane::Compile, titania_core::Lane::Clippy, titania_core::Lane::AstGrep, titania_core::Lane::Dylint, titania_core::Lane::PanicScan, titania_core::Lane::PolicyScan, titania_core::Lane::Test, titania_core::Lane::Deny, titania_core::Lane::Build])) {
    ...
    fn report_reject_never_both_empty(
        ...
        let findings: Box<[titania_core::Finding]> = if code_size > 0 {
            ...
            }).take(code_size).collect::<Vec<_>>().into_boxed_slice()
        } else {
            Box::new([])
        };
        ...
        let failures: Box<[titania_core::LaneFailure]> = if gate_size > 0 {
            ...
            }).take(gate_size).collect::<Vec<_>>().into_boxed_slice()
        } else {
            Box::new([])
        };
    ...
    fn reject_kind_classification_complete(
        ...
        prop_assume!(code_size > 0 || gate_size > 0);
        let findings: Box<[titania_core::Finding]> = if code_size > 0 {
            let rule_id = RuleId::new("CLIPPY_UNWRAP_USED").unwrap();
            let loc = WorkspacePath::new("src/lib.rs").unwrap();
            std::iter::repeat_with(|| {
    ...
    fn location_span_col_non_negative(
        ...
        assert_eq!(loc.col_start(), col_start);
        assert_eq!(loc.col_end(), col_end);
    }
