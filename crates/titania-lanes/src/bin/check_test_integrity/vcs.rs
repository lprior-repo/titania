...
use super::{ChangedFile, ChangedFiles, RootInfo, Vcs, scan::is_test_path};
...
fn git_changed_files(target: &TargetProject, base: &str) -> Result<ChangedFiles, String> {
...
fn jj_changed_files(target: &TargetProject, base: &str) -> Result<ChangedFiles, String> {
