# Non-applicability evidence for v15.F2 verifier=proptest

Reason: v1.5 lane profile selects proptest (empirical) + Kani/Verus (deductive bounded).
Verifier 'proptest' is not the primary tool for this obligation per spec §4 and proof-coverage-matrix.
